...
row12 = [16, 39, 5, 42, 96, 35, 31, 47, 55, 58, 88, 24, 00, 17, 54, 24, 36, 29, 85, 57]
row13 = [86, 56, 00, 48, 35, 71, 89, 7, 5, 44, 44, 37, 44, 60, 21, 58, 51, 54, 17, 58]
...
def vertical(grid):
    ...
    for k in range(len(grid)):
        for n in range(len(grid[k])):
            tem = []
            temp = 1

            for i in range(ad):
                try:
                    tem.append(globals()[f"row{k+i}"][n])
                except:
                    tem = [-1]
                    break #bottom of the grid
...
def ldiag(grid):
    ...
    for k in range(len(grid)):
        for n in range(len(grid[k])):
            ...
            for i in range(ad):
                try:
                    tem.append(globals()[f"row{k+i}"][n-i])
                except:
                    tem = [-1]
                    break #outside of grid
